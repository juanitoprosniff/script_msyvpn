...
; Configuración optimizada para soportar:
; - WebSocket (wss://)
; - Payload/Remote Proxy
; - Métodos modernos y antiguos

[dropbear-ssl]
accept = 443
connect = 127.0.0.1:143
; Opciones para compatibilidad con WebSocket y payload
TIMEOUTclose = 0
TIMEOUTidle = 3600
; Permitir protocolos modernos y antiguos
sslVersion = all
options = NO_SSLv2
options = NO_SSLv3
ciphers = ECDHE-RSA-AES256-GCM-SHA384:ECDHE-RSA-AES128-GCM-SHA256:AES256-GCM-SHA384:AES128-GCM-SHA256:HIGH:!aNULL:!MD5
EOF
...
${GREEN}✓${NC} Stunnel optimizado para WebSocket, Payload y métodos modernos/antiguos
...
STUNNEL (Puerto 443):
- Soporta: WebSocket (wss://), Payload, Remote Proxy
- Compatible con: HTTP Injector, HTTP Custom, HA Tunnel, etc.
- Protocolos: SSL/TLS modernos y antiguos
- Timeout optimizado para conexiones largas
