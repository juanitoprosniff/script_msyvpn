...
# Configuración de Stunnel COMPLETA (SSL Directo + WebSocket + Payload + SNI Flexible)
...
; Nivel de debug (aumentado para troubleshooting)
debug = 5
...
; Session cache para mejor rendimiento
sessionCacheSize = 1000
sessionCacheTimeout = 300

; Cifrados compatibles modernos (incluye ChaCha20 para móviles)
ciphers = ECDHE-RSA-CHACHA20-POLY1305:ECDHE-RSA-AES128-GCM-SHA256:ECDHE-RSA-AES256-GCM-SHA384:ECDHE-RSA-AES128-SHA256:ECDHE-RSA-AES256-SHA384:AES128-GCM-SHA256:AES256-GCM-SHA384:AES128-SHA256:AES256-SHA256:AES128-SHA:AES256-SHA:HIGH:!aNULL:!eNULL:!EXPORT:!DES:!MD5:!PSK:!RC4
...
; SSL Directo + WebSocket + Payload + SNI Flexible
; ============================================
[dropbear-ssl-443]
client = no
accept = 0.0.0.0:443
...
; NO verificar certificado del cliente (modo público)
verify = 0

; Aceptar CUALQUIER SNI (*, tu dominio, google.com, etc)
checkHost = 

; Soportar renegociación (importante para algunos clientes)
renegotiation = yes

; Delay para mejorar compatibilidad
delay = yes

; Protocol transparent (pasa todo sin modificar)
protocol = connect
protocolHost = 
protocolUsername = 
protocolPassword = 

; Permitir compresión (útil para payloads)
compression = zlib
...
; Para pruebas y métodos alternativos
; ============================================
[dropbear-ssl-777]
client = no
accept = 0.0.0.0:777
